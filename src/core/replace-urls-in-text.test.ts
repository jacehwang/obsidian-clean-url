...
describe("replaceUrlsInText", () => {
  ...
  test("cleans URLs inside Markdown links and autolinks", () => {
    const input =
      "[Docs](https://example.com/docs?utm_medium=email#intro) and <https://another.example?a=1&utm_campaign=launch>";
    const expected =
      "[Docs](https://example.com/docs#intro) and <https://another.example?a=1>";
  ...
  test("preserves trailing punctuation around raw URLs", () => {
    const input =
      "Visit https://example.com/path?utm_source=newsletter, then reply.";
  ...
  test("respects preserved tracking parameters in replacement options", () => {
    const input =
      "Visit https://example.com/path?utm_source=newsletter&utm_medium=email.";
    const expected = "Visit https://example.com/path?utm_source=newsletter.";

    expect(
      replaceUrlsInText(input, {
  ...
  test("keeps balanced parentheses that are part of the URL", () => {
    const input =
      "Reference https://example.com/Function_(mathematics)?utm_source=wiki).";
